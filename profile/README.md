...
* 🏫 **Impacto Social:** Projeto voltado para alunos do Fundamental II da rede pública.
...
* 🏫 **Social Impact:** Project designed for middle school students in public education.
...
* **Elizeu Figueiredo** (Infrastructure, Database & Security) 🔐
* **Carlos Eduardo Januario** (Frontend & UI/UX) 🎨
* **Carlos Eduardo Vernizzi Silva** (Front-end Developer) 💻
* **Rodrigo Rizzo** (Frontend & UI/UX) 🎨
* **Paulo Roberto** (Infrastructure) 🏗️
* **Clint Walker / Matheus Marques** (Management & Docs) 📂
